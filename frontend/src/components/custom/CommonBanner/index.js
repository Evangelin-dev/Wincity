...
const CommonBanner = ({
  ...
  enableBlur = false, // <-- optional blur flag
}) => {
  useEffect(() => {
  ...
  >
    ...
    >
      <div className={`carousel-item active`} data-bs-interval="10000">
        <div className="carousel-caption d-flex align-items-center justify-content-center position-relative">
          
          {enableBlur && <div className={styles.blurOverlay}></div>}
          ...
          >
            ...
            <div className={`m-auto ${styles.banner_sub_title} pb-5 fadeIn`}>
              {subTitle}
            </div>
          </div>
